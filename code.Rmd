...
rm(cvariables, valid_cvalues, valid_jvalues, variables1, variables_to_remove, variables2, valid_j2values)
...
rm(columns, tea_vars, new_column, suffix)
...
rm(cols, suffix, var, variables, cvariables)
